<x-app-layout>
    <div class="mb-8">
        ...
        <p class="text-sm text-gray-500 mt-1">Perbarui nama kategori produk.</p>
    </div>
        ...
        <form action="{{ route('owner.categories.update', $category) }}" method="POST">
            ...
            <div class="p-6 md:p-8 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $category->name) }}" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm sm:text-sm" required>
                </div>
            </div>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex items-center justify-end space-x-3">
                ...
                <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg text-sm font-bold shadow-sm transition-colors">Simpan Perubahan</button>
            </div>
        </form>
    </div>
</x-app-layout>
