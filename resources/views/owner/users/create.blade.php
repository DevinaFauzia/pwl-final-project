                ...
                <form action="{{ route('owner.users.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}"
                               class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                               required>
                        <p class="text-xs text-slate-500 mt-1">Email harus unik dan akan digunakan untuk login</p>
                    </div>
                    ...
                    <div class="mb-4">
                        <label for="password_confirmation" class="block text-sm font-medium text-slate-700 mb-2">Konfirmasi Password <span class="text-red-500">*</span></label>
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-xs text-slate-500 mt-1">
                            Manager = Kepala Cabang, Warehouse = Staff Gudang, Cashier = Kasir, Supervisor = Pengawas Transaksi
                        </p>
                    </div>

                    <div class="mb-6">
                        <label for="branch_id" class="block text-sm font-medium text-slate-700 mb-2">Cabang <span class="text-red-500">*</span></label>
                    ...
                    <div class="flex gap-3">
                        <button type="submit" class="bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-lg transition-colors font-medium">
                            Buat Pengguna
                        </button>
                        <a href="{{ route('owner.users.index') }}" class="bg-slate-300 hover:bg-slate-400 text-slate-700 px-4 py-2 rounded-lg transition-colors font-medium">
                            Batal
                        </a>
                    </div>
                </form>
